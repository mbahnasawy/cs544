	...
	public static void task1() {
		...
		try {
            ...
            session.persist(c2);
           	...
           	Product p1 = new Product("Hp Laptop", "Pavalion 15 16G Ram");
           	session.persist(p1);
           	
         	Product p2 = new Product("Dell Laptop", "Probook 8 core 16G Ram");
           	session.persist(p2);
           	
         	Product p3 = new Product("Macbook", "Air 13 8G Ram");
           	session.persist(p3);
